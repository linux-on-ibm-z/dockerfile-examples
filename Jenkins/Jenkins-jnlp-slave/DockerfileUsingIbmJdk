...
# Download IBMJDK
&& wget http://public.dhe.ibm.com/ibmdl/export/pub/systems/cloud/runtimes/java/8.0.5.25/linux/s390x/ibm-java-s390x-sdk-8.0-5.25.bin \
...
&& ./ibm-java-s390x-sdk-8.0-5.25.bin -r installer.properties

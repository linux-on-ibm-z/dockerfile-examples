...
############### Dockerfile for Couchbase version 6.0.4 ############
#
...
# Install Java
 ...
 && chmod +x ibm-java-s390x-sdk-8.0-6.31.bin \
 && ./ibm-java-s390x-sdk-8.0-6.31.bin -r installer.properties \
 && java -version \
...
# Clone Couchbase
 ...
 && ../repo init -u git://github.com/couchbase/manifest -m released/couchbase-server/6.0.4.xml \
 && ../repo sync \
 && cd $SOURCE_ROOT \
# Patch files
